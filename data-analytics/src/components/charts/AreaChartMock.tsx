interface AreaChartMockProps {
  title: string;
}

function AreaChartMock({ title }: AreaChartMockProps) {
  const dataPoints = [20, 35, 28, 45, 52, 48, 65, 70, 78, 85, 90, 95];
